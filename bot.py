...
💰 Купить - получить инструкции по покупке VK Coin

📋 Цены - узнать текущий курс продажи VK Coin

🏄 Получить VK Coins бесплатно! - узнать список бонусов, которые предоставляет площадка VCoinBank

📝 Инструкция — получить инструкцию по покупке VK Coin"""

    Intro = """✌️ Привет!
Этот бот позволяет купить VK Coin по выгодному курсу‼️
Если сомневаешься в нашей честности, можешь прочитать отзывы наших покупателей (Отзывы покупателей: https://vk.cc/9gFQYk) и попробовать купить на маленькую сумму для начала.
"""
...
💰 100 000 VK Coin - 15 рублей, 
💰 500 000 VK Coin - 75 рублей, 
💰 2 000 000 VK Coin - 234 рубля, 
💰 5 000 000 VK Coin - 585 рублей."""
...
Напишите сообщение #проблема, чтобы мы смогли помочь Вам."""
